...
-- Modified - Added extra strings useful for this application
---------------------------------------------------------------------------------]]
...
"tmr.timer", "Getting...", "Failed!", "Success", "HTTP request failed", "Heap before handshake:",
"get", "heap", "id", "kv", "print", "sjson", "table", "tls", "tls.socket", "u8g2.display", "verify"
